...
<section class="marketplace-detail">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="app">
					<a href="<?php echo get_field('website'); ?>" target="_blank" class="visit" style="background-color: <?php echo the_field('cor'); ?>;">visit website</a>
		          	<div class="row">
			            ...
			            <div class="col-sm-10 detalhes">
			            	...
			            	<nav>
			            		<ul>
			            		    <li><a href="#appinfo" style="color: <?php echo the_field('cor'); ?>;">app info</a></li>
			            		    <li><a href="#features" style="color: <?php echo the_field('cor'); ?>;">características</a></li>
			            		    <li><a href="#screenshots" style="color: <?php echo the_field('cor'); ?>;">screenshots</a></li>
			            		   <!--  <li><a href="#usecases" style="color: <?php echo the_field('cor'); ?>;">casos de uso</a></li> -->
			            		</ul>
			            	</nav>
		...
		<div class="row">
			<div class="col-sm-8">
				...
				<!-- WHO IS USING IT -->
				<div id="features" class="description">
					<h3>Quem já está usando</h3>
					<?php 

						$quem_usa = get_field('quem_usa');
						if ($quem_usa != ""){
							echo $quem_usa;
						}else{
							echo "Em breve";
			...
			<div class="col-sm-4">
				<div class="details">
					...
					<p>&nbsp;</p>
					<div class="row">
						<button style="background-color: <?php echo the_field('cor'); ?>;" class="btn btn-implementa col-xs-12" data-toggle="modal" data-target="#contactModal">Quero implementar esse App!</button>
					</div>
				</div>
			</div>
		</div>
