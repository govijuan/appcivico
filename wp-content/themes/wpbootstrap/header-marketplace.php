...
<html <?php language_attributes(); ?>>
 ...
 <!-- market -->
    ...
    <link href="<?php bloginfo('stylesheet_url');?>?a=1" rel="stylesheet">
    ...
    <header class="hidden-xs hidden-sm visible-md visible-lg">
      <div class='container'>
        <div class='col-xs-3 col-sm-2 col-md-2 col-lg-2' id='brand'>
          <a href="<?php echo site_url()."/".((pll_current_language() != "pt") ? pll_current_language() : ""); ?>" class="link-logo"><img src="<?php echo get_template_directory_uri() . "/bootstrap/css/images/logo.svg"?>" /></a>
        </div>
